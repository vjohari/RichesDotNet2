<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" MasterPageFile="~/Admin/AdminMaster.master" Inherits="RichesDotNetApp.Admin.Admin" %>
...
<tr  bgcolor="Tan" ><td>
        ...
        <br />
    <asp:Label ID="olbl" runat="server" Text=""></asp:Label>
