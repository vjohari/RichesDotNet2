    ...
    public partial class AdminControlPage : System.Web.UI.Page
    {
        ...
        protected void BroadcastAlertButton_Click(object sender, EventArgs e)
        {
            if (!MessageTextBox.Text.Equals(""))
            {
                ...
                {
                    List<String> eMailAddresses = MembershipDB.getAllEmail();
                    foreach (String eMail in eMailAddresses)
                    {
                        MessageDB.InsertMessage("admin", eMail, "Highest", "Technical Difficulties", processedMessage);
                    }
        ...
        {
            GridViewAccountSummary.DataSource = TransactionDB.GetTransactionDataForAccountNumber(AccountNoTextBox.Text);
